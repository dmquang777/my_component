...
Color globalActiveColor = const Color(0xFFFFFFFF);
...
class FCheckbox extends StatefulWidget {
  FCheckbox({
    ...
    this.activeColor = const Color(0xff366AE2),
    this.checkColor,
    ...
    this.enable = true,
    this.inactiveColor = const Color(0xffCFD7E3),
  })  : assert(value != null),
        super(key: key) {
    globalActiveColor = activeColor!;
  }
...
class _FCheckboxState extends State<FCheckbox> {
  ...
  Widget build(BuildContext context) {
    final double widthSize = widget.size.size <= 48 ? 48 : widget.size.size;
          ...
          child: Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: widget.enable ? null : widget.inactiveColor,
                borderRadius: BorderRadius.all(widget.size.radius),
              ),
              child: _Checkbox(
                value: widget.value,
                onChanged: widget.onChanged,
                activeColor: widget.enable ? widget.activeColor : widget.inactiveColor,
...
/// of a [_Checkbox] with a [MaterialStateProperty].
/// In this example, the checkbox's color will be `Colors.blue` when the [_Checkbox]
...
///  * [Switch], a widget with semantics similar to [_Checkbox].
...
class _Checkbox extends StatefulWidget {
  ...
  /// of the [_Checkbox], providing a different [Color] when it is
  /// [MaterialState.disabled].
  ///
  /// ```dart
  /// Checkbox(
  ...
  ///
  /// [_Checkbox] displays a dash when its value is null.
  ///
...
class _CheckboxState extends State<_Checkbox> with TickerProviderStateMixin, ToggleableStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Set<MaterialState> activeStates = widget.isError ? (errorState..add(MaterialState.selected)) : states
      ..add(MaterialState.selected);
    final Set<MaterialState> inactiveStates = widget.isError ? (errorState..remove(MaterialState.selected)) : states
    ...
    final Set<MaterialState> focusedStates = widget.isError ? (errorState..add(MaterialState.focused)) : states
    ...
    final Set<MaterialState> hoveredStates = widget.isError ? (errorState..add(MaterialState.hovered)) : states
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  Rect _outerRectAt(Offset origin, double t) {
    ...
    final double size = sizeValue.size - inset * _kStrokeWidth;
  ...
  Paint _createStrokePaint() {
    return Paint()
      ..color = globalActiveColor.computeLuminance() >= 0.5 ? Colors.black : checkColor
      ..style = PaintingStyle.stroke
      ..strokeWidth = sizeValue.strokeWidth / 2;
  }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Offset origin = size / 2.0 - Size.square(sizeValue.size) / 2.0 as Offset;
...
class FCheckboxSize {
  ...
  static const size32 = FCheckboxSize(
    size: 32,
    radius: Radius.circular(6),
    strokeWidth: 3,
  );

  static const size48 = FCheckboxSize(
    size: 48,
